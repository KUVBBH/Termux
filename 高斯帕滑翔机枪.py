...
video = cv2.VideoWriter(sys.path[0]+'/out.mp4', fourcc,FPS, (2000,2000),isColor=False)
mv=1
...
while True :
    #############上方的点点#############
    #a[0,random.randint(0,99)] = 255
    #a[2,random.randint(0,99)] = 255
    #a[4,random.randint(0,99)] = 255
    #a[6,random.randint(0,99)] = 255
    #a[8,random.randint(0,99)] = 255
    #############上方的点点#############    
